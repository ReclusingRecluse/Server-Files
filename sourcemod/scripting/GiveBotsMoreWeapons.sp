...
public Action Timer_GiveWeapons(Handle timer, any data)
{
	...
	int clientweapon = GetPlayerWeaponSlot(client,0);
	//new clientweapon1 = GetPlayerWeaponSlot(client,1);
	//new clientweapon2 = GetPlayerWeaponSlot(client,2);
					...
					case 3:
						{
							...
							TF2Attrib_SetByName(clientweapon, "Blast radius decreased", 0.0);
